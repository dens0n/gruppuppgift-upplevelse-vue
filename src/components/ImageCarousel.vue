...
const nextImage = () => {
    currentImageIndex.value = (currentImageIndex.value + 1) % props.article.img.length;
};

const prevImage = () => {
    currentImageIndex.value = (currentImageIndex.value - 1 + props.article.img.length) % props.article.img.length;
};
</script>
